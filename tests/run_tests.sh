...
for suite in decoder unicode wcwidth buffer undo edit fileio relpath visual_line utf8_validate rect_undo replace transform subprocess shell adjust history abuf tilde keymap kill_ring insert_file status_bar cjk_indic warnings ctags; do
