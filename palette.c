...
const PaletteEntry palette[] = {
	...
	{ 0x2023, { 0xE2, 0x80, 0xA3, 0x00 }, 3, false }, // ‣
	{ 0x00B7, { 0xC2, 0xB7, 0x00 }, 2, false },	  // ·
	{ 0x2035, { 0xE2, 0x80, 0xB5, 0x00 }, 3, false }, // ‵
	...
	{ 0x2117, { 0xE2, 0x84, 0x97, 0x00 }, 3, false }, // ℗
	{ 0x2120, { 0xE2, 0x84, 0xA0, 0x00 }, 3, false }, // ℠
	{ 0x2032, { 0xE2, 0x80, 0xB2, 0x00 }, 3, false }, // ′
	{ 0x2033, { 0xE2, 0x80, 0xB3, 0x00 }, 3, false }, // ″
	{ 0x203B, { 0xE2, 0x80, 0xBB, 0x00 }, 3, false }, // ※
	...
	{ 0x223C, { 0xE2, 0x88, 0xBC, 0x00 }, 3, false }, // ∼
